                                                ...
                                                <div class="friend-box">
                                                    ...
                                                    <div class="frnd-meta">
                                                        @foreach($user->images as $image)
                                                            <img class="list-image avatar_follow" src="{{ asset($image->image_url) }}"  alt="">
                                                        @endforeach
                                                        <div class="frnd-name">
                                                        ...
                                                        @else
                                                            <button type="submit" data-id="{{ $user->id }}" action="{{ route('follow.add', $user->id)}}" class="btn btn-danger" id="follow">{{ trans('homepage.follow') }}</button>
                                                        @endif
